...
//            [udpSocket sendData:[@"test" dataUsingEncoding:NSUTF8StringEncoding] toHost:@"192.168.18.121" port:25000 withTimeout:-1 tag:10];
        });
                                         ...
                                         withFilterContext:(id)filterContext
{
	...
	if (msg)
	{
		...
		*/
		...
		[self logMessage:msg];
//        [udpSocket sendData:[@"AAAA" dataUsingEncoding:NSUTF8StringEncoding] toHost:@"192.168.18.121" port:25000 withTimeout:60 tag:10];
	}
	else
	{
